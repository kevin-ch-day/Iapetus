...
from iapetus.probes.environment import collect_device_probe_state
...
def test_device_probe_without_adb(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("iapetus.probes.environment.shutil.which", lambda name: None)
...
def test_device_probe_error_on_timeout(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("iapetus.probes.environment.shutil.which", lambda name: "adb")
    monkeypatch.setattr(
        "iapetus.probes.environment.subprocess.run",
